...
public class WorkerFrame extends javax.swing.JFrame {
    ...
    public WorkerFrame(HotelService hotelService) {
        try {
            initComponents();
            this.hotelService = hotelService;
            showWorkerData(hotelService.getWorkerList());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    private void newBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newBtnActionPerformed
        NewWorkerFrame nWorkerF = new NewWorkerFrame(hotelService);
        nWorkerF.setVisible(true);
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        try {
            ...
            EditWorkerFrame eWorkerF = new EditWorkerFrame(selectedRow, hotelService);
            eWorkerF.setVisible(true);
            showWorkerData(hotelService.getWorkerList());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delBtnActionPerformed
        try {
            ...
            if (isMessage == JOptionPane.YES_OPTION) {
                boolean isDeleted = hotelService.deleteWorker(selectedRow);
                if (isDeleted) {
                    JOptionPane.showMessageDialog(null, "Worker has been succesfully deleted!");
                    showWorkerData(hotelService.getWorkerList());
                } else {
                    JOptionPane.showMessageDialog(null, "Problem! Worker has not been succesfully deleted!", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        try {
            ...
            List<Worker> workerList = hotelService.searchWorkerData(keyword);
            showWorkerData(workerList);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
     ...
     */
    private void showWorkerData(List<Worker> workerList) {
        try {
            ...
            for (Worker worker : workerList) {
                Object[] data = new Object[]{
                    worker.getId(), worker.getR(), worker.getName(), worker.getSurname(), worker.getDob(), worker.getFatherName(), worker.getPhone(), worker.getEmail()
                };
                model.addRow(data);
            }
